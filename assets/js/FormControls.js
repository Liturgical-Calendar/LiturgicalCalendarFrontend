...
class FormControls {
    ...
    static CreateRegionalFormRow(element = null) {
         ...
         */
        // color is always an array per API contract
    ...
    static CreateDoctorRow(element = null) {
        ...
        if( 'strtotime' in liturgical_event ) {
            ...
            <input list="existingLiturgicalEventsList" value="${liturgical_event.strtotime.event_key}" class="form-control litEvent litEventStrtotime existingLiturgicalEventName" id="onTheFly${FormControls.uniqid}StrToTime-eventKey" required>
            </div>`;
        } else {
            formRow += `<div class="form-group col-sm-1">
