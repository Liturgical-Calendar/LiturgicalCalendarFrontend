...
$API_EXTEND_HOWTO_6a = _( "Translations of the above mentioned festivities MUST NOT be done simply based on the linguistic abilities of the translator, but MUST be taken from the Roman Missal used in the region for which the translation is accomplished." );
$API_EXTEND_HOWTO_6b = _( "Translations of the above mentioned festivities may change from one edition of the Roman Missal to the next; translators should simply use the most recent edition of the Roman Missal for their region as a reference." );
$API_EXTEND_HOWTO_6c = _( "This API intends to be historically correct as regards the calculation of the dates and the precedence of the festivities, but does not pretend historical accuracy as regards differences in the translations of the festivities over time." );
                ...
                <div class="d-flex flex-column gap-3 flex-lg-row bg-secondary text-light p-4 m-2">
                    <div class="col-12 col-lg-3">
                        ...
                        <ol class="mb-0">
                            ...
                            <li><a href="https://translate.johnromanodorazio.com/projects/liturgical-calendar/proprium-de-sanctis-2002/" target="_blank" class="text-light"><small>Proprium de Sanctis 2002 <i class="fas fa-up-right-from-square ms-2"></i></small></a></li>
                            <li><a href="https://translate.johnromanodorazio.com/projects/liturgical-calendar/proprium-de-sanctis-2008/" target="_blank" class="text-light"><small>Proprium de Sanctis 2008 <i class="fas fa-up-right-from-square ms-2"></i></small></a></li>
                            <li><a href="https://translate.johnromanodorazio.com/projects/liturgical-calendar/proprium-de-tempore/" target="_blank" class="text-light"><small>Proprium de Tempore <i class="fas fa-up-right-from-square ms-2"></i></small></a></li>
